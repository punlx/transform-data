import { transformUsersToDepartment } from '../src/transformation';
import { User } from '../src/types';

describe('transformUsersToDepartment', () => {
  it('should group users by department and produce correct stats', () => {
    ...
    const result = transformUsersToDepartment(mockUsers);
